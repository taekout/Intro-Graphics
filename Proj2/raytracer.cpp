...
//	Parser		m_parser;
	...
	COLOR3	RayIntersectWithSpheres(int i, int j);
...
COLOR3 Raytracer::RayIntersectWithSpheres(int i, int j)
{
	//RayIntersect
...
//		}
	...
	{
		COLOR3 color;
		color.R = m_shading.color.R;
		color.G = m_shading.color.G;
		color.B = m_shading.color.B;
cout << closest_t << endl;
		return	color;
	}
	COLOR3 color = {0, 0, 0};
